...
\noindent\fcolorbox{blue}{white}{
    \begin{minipage}{\dimexpr\linewidth-2\fboxsep-2\fboxrule}
        \textcolor{blue}{\textbf{$\diamond$ Property of unitary matrices}}
        \vspace{0.5em}
...
\noindent\fcolorbox{violet}{white}{
    \begin{minipage}{\dimexpr\linewidth-2\fboxsep-2\fboxrule}
        \textcolor{violet}{\textbf{$\rightarrow$ Example 2.10}} \\
...
\noindent\fcolorbox{violet}{white}{
    \begin{minipage}{\dimexpr\linewidth-2\fboxsep-2\fboxrule}
        \textcolor{violet}{\textbf{$\rightarrow$ Examples}}
        \vspace{0.5em}
...
\noindent\fcolorbox{violet}{white}{
    \begin{minipage}{\dimexpr\linewidth-2\fboxsep-2\fboxrule}
        \textcolor{violet}{\textbf{$\diamond$ What are those $N, N+L$ subscripts?}}
        \vspace{0.5em}
