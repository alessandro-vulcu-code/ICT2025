...
\section*{MMSE estimator for a Complex Gaussian scalar through a channel}
...
\section*{MMSE estimator for a Complex Gaussian vector representing a channel}
...
\section*{Random digression on why radio doesn't transmit on baseband and on ADSL}
...
\section*{Random digression on FDD (Frequency Division Duplex) and TDD (Time Divison Duplex)}
...
\section*{Time discretization: discrete representation of the channel $c[\ell]$ (+critical sampling)}
...
\section*{Idea of pulse shaping: from a digital signal $x[n]$ to an analog signal}
...
\section*{Channel models (frequency selective, FIR, flat channel); channel normalization and average symbol energy; vector representation of a SISO FIR channel}
