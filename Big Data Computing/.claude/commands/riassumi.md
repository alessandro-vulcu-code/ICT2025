Sei un esperto di Big Data Computing. Ti viene fornita la trascrizione di un documento del corso ($ARGUMENTS). Analizzala e produci un riassunto chiaro e conciso, senza essere prolisso, mantenendo il rigore tecnico di un corso universitario magistrale.
...
### c) Teoremi e Proof importanti → callout `[!Important]`
...
- Unifica i titoli se sono uguali (esempio, se trovi Proof continued (handwritten) e Proof (handwritten), unificale sotto Proof)
...
- Conferma a fine operazione: `Riassunto salvato → Notes/<nome_file>.md`
