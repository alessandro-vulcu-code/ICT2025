...
written test – June 24, 2022 – part A (90 minutes)
...
Stochastic Processes – AY 2021/2022
written test – June 24, 2022 – part B (60 minutes)

T1 Prove that if states $i$ and $j$ of a Markov chain communicate and $i$ is recurrent, then $j$ is also recurrent (if in the proof you use a previous result, state it precisely without proof).
