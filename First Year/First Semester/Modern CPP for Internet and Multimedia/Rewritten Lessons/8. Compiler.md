...
- [[5. Namespaces#Interfaces and Modular Code|Interfaces and modular code]]: explains the source-level organization that headers and translation units support.
- [[6 Functions#Macros|Macros]]: covers macro usage before seeing how the preprocessor expands it.
- [[17. Templates#Definition Placement|Template definition placement]]: explains why template definitions often need to be visible at compile time.
- [[20. Standard Library#Standard Library Design|Standard Library design]]: connects headers and libraries with reusable standard facilities.
- [[24. Threads And Lambdas#Pthread Linking|Pthread linking]]: is a concrete case where library linkage matters.
- [[22. Socket#Required Headers|Socket headers]]: applies include files and system declarations to POSIX networking APIs.
