...
- [[First Year/First Semester/Modern CPP for Internet and Multimedia/Rewritten Lessons/1. Types And Declarations#Boolean|Boolean values]]: underpins conditions in `if`, `while`, and logical expressions.
- [[6 Functions#Returning Values|Function exits]]: connects `return` statements with function control flow.
- [[20. Standard Library#Iterators|Iterators]]: explains the traversal model behind range-for loops and many `for` loops.
- [[14. Operator Overloading#Binary and Unary Operators|Operator syntax]]: relates increment, comparison, and logical operators to expression behavior.
- [[26. Inter-thread Communication#Busy Waiting|Busy waiting]]: is a concurrency case where loop control has practical performance consequences.
