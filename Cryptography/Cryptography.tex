...
\setlength{\headheight}{14.5pt} % Fix for fancyhdr warning with 12pt font
...
\newtheoremstyle{mythmstyle}%
    {}%
    {}%
    {\itshape}% % Ho corretto in \itshape per il corpo del testo (funziona meglio di \it)
    {}%
...
\newpage
\input{Lessons/Lesson5/Unit3-.tex}
